...
<div class="text-center">
                <h1 class="font">
                    <span >Booking</span>
                    <span class="text-yellow tracking-wide">Details</span>
                </h1> 
</div>
<div class="container">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('ads.update', $ads->adsId) }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 col-6">
                                <input id="adsStatus" value="{{ $ads->adsStatus}}" type="text" class="form-control @error('adsStatus') is-invalid @enderror" name="adsStatus" readonly>
                            </div>
                        </div>
                        <hr />
                        ...
                        <div class="row">
                                            <label class="col-sm-3 col-md-2 col-5" style="font-weight:bold;">Image</label>
