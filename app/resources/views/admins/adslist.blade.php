                            ...
                            <tr class="border-b border-gray-200 hover:bg-gray-100">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-left">
                                        <span>{{$value->adsId}}</span>
                                    </div>
                                </td>

                                <td class="py-3 px-6 text-left whitespace-nowrap">
                                <a href="{{route('admins.editstatus', ['adsId' => $value->adsId])}}">
                                    <div class="flex items-center">
                                    <div class="transform hover:scale-110">
                                        <span class="font-medium">{{$value->adsTitle}}</span>
                                    </div>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <span>{{$value->adsCompany}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                ...
                                <td class="py-3 px-6 text-center">
                                    <div class="flex items-center justify-center">
                                        <span>{{$value->timeslot}}</span>
                                    </div>
                                </td>
                                <td class="py-3 px-6 text-center">
                                    <span class="bg-purple-200 text-red-600 py-1 px-3 rounded-full text-xs">{{$value->adsStatus}}</span>
                                </td>
