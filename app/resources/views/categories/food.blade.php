...
<section>
  <div class="container-fluid">
    <div class="container">
      ...
      @if ($food->categoryId== 4 )
        <div class="col-sm-4">
          <div class="card text-center">
            <div class="title">
              <h2>{{$food->categoryPlan}}</h2>
            </div>
            <div class="price">
              <h4><sup>RM</sup>{{$food->categoryPrice}}</h4>
            </div>
            <div class="option">
              <ul>
                <li> <i class="fa fa-check" aria-hidden="true"></i> {{$food->categoryMedia}} media only</li>
                <li> <i class="fa fa-check" aria-hidden="true"></i> Ads boosting : {{$food->categoryBoost}} days</li>
                <li> <i class="fa fa-check" aria-hidden="true"></i> Estimated 2 thousand people reached per day </li>
              </ul>
              <a href="{{ route('ads.calendar',['categoryId' => $food->categoryId])}}" class="">
                            <p>
