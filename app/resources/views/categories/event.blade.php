...
<section>
  <div class="container-fluid">
    <div class="container">
      <div class="row">
      @foreach($categories as $fair) 
      @if ($fair->categoryId== 1 )
        <div class="col-sm-4">
          <div class="card text-center">
            <div class="title">
              <h2>{{$fair->categoryPlan}}</h2>
            </div>
            <div class="price">
              <h4><sup>RM</sup>{{$fair->categoryPrice}}</h4>
            </div>
            <div class="option">
              <ul>
                <li> <i class="fa fa-check" aria-hidden="true"></i> {{$fair->categoryMedia}} media only</li>
                <li> <i class="fa fa-check" aria-hidden="true"></i> Ads boosting : {{$fair->categoryBoost}} days</li>
                <li> <i class="fa fa-check" aria-hidden="true"></i> Estimated 2 thousand people reached per day </li>
              </ul>
              <a href="{{ route('ads.calendar',['categoryId' => $fair->categoryId])}}" class="">
                            <p>
